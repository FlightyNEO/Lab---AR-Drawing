...
//                self.delegate?.resetScene()
        ...
        let availableScenes: [String] = {
            ...
            return fileEnumerator.compactMap { element in
                ...
                guard
                    ...
                    url.lastPathComponent != "lighting.scn" else { return nil }
    ...
    private func shapePicker() -> UIViewController {
        let shapes = Shape.allCases //[.box, .sphere, .cylinder, .cone, .torus]
    ...
    private func sizePicker() -> UIViewController {
        let sizes = Size.allCases //[Size] = [.small, .medium, .large]
